...
def create_posts_blueprint(mysql):
    ...
    def posts():
        ...
        # 게시글 생성
            ...
            sql = "insert into oz(title, content) values(%s, %s)"
    ...
    def post(id):
        ...
        if request.method == "GET":
            sql = f"select * from oz where id={id}"
            cursor.execute(sql)
            ...
            sql = "update oz set title=%s, content=%s where id=%s"
